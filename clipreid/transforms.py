...
def get_transforms(image_size,
    ...
    val_transforms = A.Compose([A.Resize(height=image_size[0], width=image_size[1], interpolation=cv2.INTER_LINEAR, p=1.0)
,
    ...
    train_transforms = A.Compose([A.Resize(height=image_size[0], width=image_size[1], interpolation=cv2.INTER_LINEAR, p=1.0)
,
                                  A.Normalize(mean, std),
                                  ToTensorV2(),
                                ])
